...
`;
  const _dom = `
<div class="webloog-wrap" dir="rtl" lang="fa" data-theme="${webloogTheme}">
  ...
  <div style="padding: 20px; border-top: 1px solid var(--border); text-align: center">
    <a href="http://webloog.ir/post/66" style="opacity: 1 !important; display: inline-block !important; position: relative !important;color:var(--text)!important" title="دریافت کد آخرین نظرات بلاگفا | webloog.ir">طراحی شده توسط وبلاگ‌ :: webloog</a>
  </div>
  <div></div>
</div>
`;
  ...
  console.log("خطایی در کد نظرات پیش آمده", error);
}
